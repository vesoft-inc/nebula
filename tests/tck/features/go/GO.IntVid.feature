...
Feature: IntegerVid Go  Sentence
  ...
  Scenario: go step limit
    When executing query:
      """
      GO FROM hash("Tim Duncan") OVER like LIMIT [10,10];
      """
    Then a SemanticError should be raised at runtime:
    When executing query:
      """
      GO FROM hash("Tim Duncan") OVER like LIMIT ["10"];
      """
    Then a SemanticError should be raised at runtime:
    When executing query:
      """
      GO FROM hash("Tim Duncan") OVER like LIMIT [a];
      """
    Then a SemanticError should be raised at runtime:
    When executing query:
      """
  ...
  Scenario: go step sample
    When executing query:
      """
      GO FROM hash("Tim Duncan") OVER like SAMPLE [10,10];
      """
    Then a SemanticError should be raised at runtime:
    When executing query:
      """
      GO FROM hash("Tim Duncan") OVER like SAMPLE ["10"];
      """
    Then a SemanticError should be raised at runtime:
    When executing query:
      """
      GO FROM hash("Tim Duncan") OVER like SAMPLE [a];
      """
    Then a SemanticError should be raised at runtime:
    When executing query:
      """
