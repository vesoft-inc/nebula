...
def given_nebulacluster(
    ...
    docker_group= pytestconfig.getoption("docker_group")
    docker_tag = pytestconfig.getoption("docker_tag")
    k8s_util = K8SUtil(kubeconfig)
    _, name = k8s_util.create_nebulacluster(graphd_num, metad_num, storaged_num, docker_group, docker_tag)
