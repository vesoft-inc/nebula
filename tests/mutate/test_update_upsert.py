...
class TestUpdateVertex(NebulaTestSuite):
    ...
    def test_update_edge(self):
        # resp = self.execute('FETCH PROP "200"->"101"@0 OF select '
    ...
    def test_update_edge_failed(self):
        ...
        resp = self.execute('UPDATE EDGE "200" -> "101"@0 OF nonexistentEdgeTypeName '
    ...
    def test_upsert_vertex(self):
        ...
        resp = self.execute('UPDATE VERTEX "104" '
                                  'SET course.credits = $^.course.credits + 1  '
                                  'WHEN $^.course.name == "CS" AND $^.course.credits > 2 '
                                  "YIELD $^.course.name AS Name, $^.course.credits AS Credits")
        self.check_resp_failed(resp)
        ...
        # resp = self.execute('UPSERT VERTEX "110" '
        ...
        resp = self.execute('UPSERT VERTEX "111" '
        ...
        resp = self.execute('UPSERT VERTEX "112" '
        ...
        # update student_default.age with string value
        resp = self.execute('UPSERT VERTEX "113" '
        ...
        # TODO: storage not ready
        # resp = self.execute('UPSERT VERTEX "115" '
        ...
        # the filter is always true.
        # TODO: storage not ready
        # resp = self.execute('UPSERT VERTEX "116" '
        ...
        # the filter is always true.
        # TODO: storage not ready
        # resp = self.execute('UPSERT VERTEX "117" '
    ...
    def test_update_not_exist(self):
        ...
        resp = self.execute('UPDATE VERTEX "1010000" '
    ...
    def test_upsert_then_insert(self):
        resp = self.execute('UPSERT VERTEX "100" SET building.name = "No1"')
        self.check_resp_succeeded(resp)
        ...
        resp = self.execute('UPSERT VERTEX "101" SET building.name = "No1"')
        self.check_resp_succeeded(resp)
