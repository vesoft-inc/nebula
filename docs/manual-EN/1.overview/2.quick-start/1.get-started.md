...
## Hardware Requirement (Suggestion)

An `SSD` disk is required with at least **50GB** space available.
And memory should be more than **8GB**.

The service might crash without enough memory/disk.
