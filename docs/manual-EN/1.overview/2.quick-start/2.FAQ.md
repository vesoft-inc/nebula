...
- [Frequently Asked Questions](#frequently-asked-questions)
  - [Trouble Shooting](#trouble-shooting)
    ...
    - [Invalid Configuration Changes](#invalid-configuration-changes)
...
Invalid configuration changes happens because **Nebula Graph** gets configuration from meta by default. If you want to get configuration locally, please add `local_config=true` option in flag files `metad.conf`, `storaged.conf`, `graphd.conf` respectively. Please refer to [Configs Syntax](../../3.build-develop-and-administration/3.deploy-and-administrations/server-administration/configuration-statements/configs-syntax.md) on details.
