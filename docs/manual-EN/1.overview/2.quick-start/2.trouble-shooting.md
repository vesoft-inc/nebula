...
They are at `/usr/local/nebula/log/`.

See [here](docs/manual-CN/3.build-develop-and-administration/3.deploy-and-administrations/server-administration/configuration-statements/log.md)

## Check Configs

They are at `/usr/local/nebula/etc/`.
...
See [here](docs/manual-CN/3.build-develop-and-administration/3.deploy-and-administrations/server-administration/configuration-statements/configs-syntax.md)
