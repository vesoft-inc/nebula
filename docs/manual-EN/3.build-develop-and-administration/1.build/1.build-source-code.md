...
When the building type is **DEBUG**, suggested reserved disk space is **30G** at least.
...
1. Modify **~/.bashrc** by appending the following line to the end
...
1. Input `java -version` to get your java jdk version
...
You need to compile the third-party by yourself, and sthe installation path is **/opt/nebula/third-party**
