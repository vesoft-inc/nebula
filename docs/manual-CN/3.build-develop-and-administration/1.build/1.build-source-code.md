...
Nebula Graph 提供了一个安装有完整编译环境的 docker 镜像 [vesoft/nebula-dev](https://hub.docker.com/r/vesoft/nebula-dev)，让开发者可以本地修改源码，容器内部构建和调试。只需执行如下几步便可快速参与开发：
...
经过上述的安装后，便可以在容器内部启动 Nebula Graph 的服务，Nebula Graph 默认的安装目录为 `/usr/local/nebula`
