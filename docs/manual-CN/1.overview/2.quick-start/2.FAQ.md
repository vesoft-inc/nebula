...
- [常见问题](#%e5%b8%b8%e8%a7%81%e9%97%ae%e9%a2%98)
  - [Trouble Shooting](#trouble-shooting)
    ...
    - [配置启动不生效](#%e9%85%8d%e7%bd%ae%e5%90%af%e5%8a%a8%e4%b8%8d%e7%94%9f%e6%95%88)
...
改了配置启动不生效，因为 **Nebula Graph** 默认从 meta 获取配置，在配置文件 `metad.conf`、`storaged.conf`、`graphd.conf` 中分别添加 `local_config=true`，从本地配置文件获取。详情参考[服务器配置](../../3.build-develop-and-administration/3.deploy-and-administrations/server-administration/configuration-statements/configs-syntax.md)。
