...
compiler_flags="-fPIC -DPIC -DFOLLY_HAVE_LIBDWARF_DWARF_H -DFOLLY_HAVE_MEMRCHR -Wno-noexcept-type -Wno-error=parentheses -Wno-error=shadow=compatible-local -Wno-error=stringop-truncation  $EXTRA_CXXFLAGS"
exe_linker_flags="-static-libgcc -static-libstdc++ $EXTRA_LDFLAGS -lunwind"
