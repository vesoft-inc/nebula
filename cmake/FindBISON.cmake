  ...
  macro(BISON_TARGET Name BisonInput BisonOutput)
    ...
    elseif("${BISON_TARGET_ARG_VERBOSE}" MATCHES ";")
      ...
      add_custom_command(OUTPUT ${BISON_TARGET_outputs}
        COMMAND ${CMAKE_COMMAND} -E env ${BISON_EXECUTE_ENV} ${BISON_EXECUTABLE} ${BISON_TARGET_cmdopt} -o ${BisonOutput} ${BisonInput}
        VERBATIM
        DEPENDS ${BisonInput}
        COMMENT "[BISON][${Name}] Building parser with bison ${BISON_VERSION}"
        WORKING_DIRECTORY ${_BISON_WORKING_DIRECTORY})
      # End customized by Nebula Graph
