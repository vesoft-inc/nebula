...
#include "vgraphd/SimpleAuthenticator.h"

namespace vesoft {
namespace vgraph {

VGraphService::VGraphService() {
...
folly::Future<cpp2::AuthResponse> VGraphService::future_authenticate(
...
void VGraphService::signout(int64_t sessionId) {
...
const char* VGraphService::getErrorStr(cpp2::ErrorCode result) {
    switch (result) {
