...
class MetaServiceUtils final {
 public:
  ...
  static std::string listenerKey(GraphSpaceID spaceId, PartitionID partId, cpp2::ListenerType type);

  static std::string listenerPrefix(GraphSpaceID spaceId);

  static std::string listenerPrefix(GraphSpaceID spaceId, cpp2::ListenerType type);
