...
class MetaHttpAdminHandlerTestEnv : public ::testing::Environment {
public:
    void SetUp() override {
        ...
        rootPath_ = std::make_unique<fs::TempDir>("/tmp/MetaHttpAdminHandler.XXXXXX");
        ...
        WebService::registerHandler("/admin-dispatch", [this] {
            auto handler = new meta::MetaHttpAdminHandler();
...
TEST(RequstToMetaAdminTriggerStorageCompact, MetaCompactTest) {
...
int main(int argc, char** argv) {
    ...
    ::testing::AddGlobalTestEnvironment(new nebula::meta::MetaHttpAdminHandlerTestEnv());
