...
StatusOr<TagIndexID> getTagIndexID(GraphSpaceID spaceId, const std::string& indexName) {
    ...
    return Status::TagIndexNotFound(folly::stringPrintf("Tag Index %s not found", indexName.c_str()));
}
...
StatusOr<EdgeIndexID> getEdgeIndexID(GraphSpaceID spaceId, const std::string& indexName) {
    ...
    return Status::EdgeIndexNotFound(folly::stringPrintf("Edge Index %s not found", indexName.c_str()));
