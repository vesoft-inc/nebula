...
/// If a function without a size parameter is defined, the program should also define the
/// corresponding function with a size parameter. If a function with a size parameter is defined,
