...
//     ASSERT_EQ(esResult.items[3], plugin::ESQueryResult::Item("4",
//     "Nebulagraph是最好的图数据库")); ASSERT_EQ(esResult.items[4],
//     plugin::ESQueryResult::Item("5", "NebulaGraph是一个图数据库"));
//   }
//   {
...
//                 return a.vid < b.vid;
//               });
//     ASSERT_EQ(esResult.items[0], plugin::ESQueryResult::Item("4",
//     "Nebulagraph是最好的图数据库")); ASSERT_EQ(esResult.items[1],
//     plugin::ESQueryResult::Item("5", "NebulaGraph是一个图数据库"));
//   }
//   {
