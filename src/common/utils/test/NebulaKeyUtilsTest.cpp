...
class KeyUtilsTestBase : public ::testing::Test {
 public:
  explicit KeyUtilsTestBase(size_t vIdLen) : vIdLen_(vIdLen) {}
  ...
  void verifyVectorTag(
    ...
    ASSERT_FALSE(NebulaKeyUtils::isVectorVertex(vecTagKey));
  ...
  void verifyVectorEdge(PartitionID partId,
    ...
    ASSERT_FALSE(NebulaKeyUtils::isVectorVertex(vecEdgeKey));
