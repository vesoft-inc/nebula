...
#include "common/datatypes/Value.h"                        // for Value, Nul...
...
#include "common/expression/test/TestBase.h"               // for TEST_EXPR
...
TEST_F(ArithmeticExpressionTest, TestArithmeticExpression) {
  ...
  }
  {
    ...
    auto add = ArithmeticExpression::makeAdd(&pool,
  ...
  {
    // 10 - e1.int
    auto minus = ArithmeticExpression::makeMinus(&pool,
