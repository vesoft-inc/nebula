...
#include "common/expression/TypeCastingExpression.h"       // for TypeCastin...
...
TEST_F(TypeCastingExpressionTest, TypeCastTest) {
  {
    auto typeCast =
        TypeCastingExpression::make(&pool, Value::Type::INT, ConstantExpression::make(&pool, 1));
  ...
  {
    auto typeCast =
        TypeCastingExpression::make(&pool, Value::Type::INT, ConstantExpression::make(&pool, 1.23));
    auto eval = Expression::eval(typeCast, gExpCtxt);
    EXPECT_EQ(eval.type(), Value::Type::INT);
    EXPECT_EQ(eval, 1);
  }
  ...
  {
    auto typeCast =
        TypeCastingExpression::make(&pool, Value::Type::INT, ConstantExpression::make(&pool, true));
    auto eval = Expression::eval(typeCast, gExpCtxt);
    EXPECT_EQ(eval.type(), Value::Type::NULLVALUE);
  }
  ...
  {
    auto typeCast =
        TypeCastingExpression::make(&pool, Value::Type::BOOL, ConstantExpression::make(&pool, 2));
    auto eval = Expression::eval(typeCast, gExpCtxt);
    EXPECT_EQ(eval.type(), Value::Type::NULLVALUE);
  }
  {
    auto typeCast =
        TypeCastingExpression::make(&pool, Value::Type::BOOL, ConstantExpression::make(&pool, 0));
    auto eval = Expression::eval(typeCast, gExpCtxt);
    EXPECT_EQ(eval.type(), Value::Type::NULLVALUE);
  }
  {
  ...
  {
    auto typeCast =
        TypeCastingExpression::make(&pool, Value::Type::SET, ConstantExpression::make(&pool, 23));
    auto eval = Expression::eval(typeCast, gExpCtxt);
    EXPECT_EQ(eval.type(), Value::Type::NULLVALUE);
  }
  {
