 ...
 */
#ifndef COMMON_VECTORINDEX_HNSW_INDEX_H_
#define COMMON_VECTORINDEX_HNSW_INDEX_H_

#include "common/vectorIndex/VectorIndex.h"
namespace nebula {
class HNSWIndex : public AnnIndex {
 public:
  HNSWIndex(GraphSpaceID graphID,
 ...
 private:
  ...
  size_t maxElements_;
  size_t efSearch_;
  std::unique_ptr<hnswlib::HierarchicalNSW<float>> rawHnsw_{nullptr};
