...
uint32_t Cpp2Ops<nebula::Vector>::write(Protocol* proto, nebula::Vector const* obj) {
  ...
  xfer += proto->writeFieldBegin("dimension", apache::thrift::protocol::T_I64, 1);
  xfer += proto->writeI64(obj->dimension);
  xfer += proto->writeFieldEnd();

  xfer += proto->writeFieldBegin("values", apache::thrift::protocol::T_LIST, 2);
...
_readField_name : { proto->readI64(obj->dimension); }
...
uint32_t Cpp2Ops<nebula::Vector>::serializedSize(Protocol const* proto, nebula::Vector const* obj) {
  ...
  xfer += proto->serializedFieldSize("dimension", apache::thrift::protocol::T_I64, 1);
  xfer += proto->serializedSizeI64(obj->dimension);
