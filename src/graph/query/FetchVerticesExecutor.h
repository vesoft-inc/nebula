...
#ifndef GRAPH_QUERY_FETCHVERTICESEXECUTOR_H_
#define GRAPH_QUERY_FETCHVERTICESEXECUTOR_H_

#include "base/Base.h"
#include "graph/query/FetchExecutor.h"
...
#endif  // GRAPH_QUERY_FETCHVERTICESEXECUTOR_H_
