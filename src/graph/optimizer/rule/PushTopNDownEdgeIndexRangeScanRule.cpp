...
#include "graph/optimizer/rule/PushTopNDownEdgeIndexRangeScanRule.h"
...
StatusOr<OptRule::TransformResult> PushTopNDownEdgeIndexRangeScanRule::transform(
  ...
  auto newIndexScan = static_cast<EdgeIndexRangeScan *>(indexScan->clone());
