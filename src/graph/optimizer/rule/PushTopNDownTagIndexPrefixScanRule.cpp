...
#include "graph/optimizer/rule/PushTopNDownTagIndexPrefixScanRule.h"
...
StatusOr<OptRule::TransformResult> PushTopNDownTagIndexPrefixScanRule::transform(
  ...
  auto newIndexScan = static_cast<TagIndexPrefixScan *>(indexScan->clone());
