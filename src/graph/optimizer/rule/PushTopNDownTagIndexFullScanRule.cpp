...
#include "graph/optimizer/rule/PushTopNDownTagIndexFullScanRule.h"
...
StatusOr<OptRule::TransformResult> PushTopNDownTagIndexFullScanRule::transform(
  ...
  auto newIndexScan = static_cast<TagIndexFullScan *>(indexScan->clone());
