...
TEST_F(SampleTest, SequentialOutRange1) { SAMPLE_RESUTL_CHECK("sample_out_sequential1", 6, 6); }

TEST_F(SampleTest, getNeighborOutRange2) { SAMPLE_RESUTL_CHECK("sample_out_sequential2", 7, 6); }
