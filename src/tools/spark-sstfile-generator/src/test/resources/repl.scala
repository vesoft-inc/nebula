bin/spark-submit --master yarn --queue fmprod --conf spark.executor.instances=29 --conf spark.executor.memory=72g --conf spark.executor.cores=2  --conf spark.executorEnv.LD_LIBRARY_PATH='/soft/server/nebula_native_client:/usr/local/lib:/usr/local/lib64' --conf spark.driver.extraJavaOptions='-Djava.library.path=/soft/server/nebula_native_client/:/usr/local/lib64:/usr/local/lib' --class com.vesoft.tools.SparkSstFileGenerator --files mapping.json nebula-spark-sstfile-generator.jar -di "2019-09-02" -mi mapping.json -pi dt -so file://home/hdp/nebula_output
...
object SparkSstFileGenerator {
  ...
  def main(args: Array[String]): Unit = {
    ...
    sc.hadoopConfiguration
      .setInt(NEBULA_PARTITION_NUMBER_KEY, mappingConfiguration.partitions)
  ...
  /**
    * Extract value from a column, and box it
    *
    * @param row     a data row
    * @param col     target column info
    * @param charset charset used to decode string column type
    */
