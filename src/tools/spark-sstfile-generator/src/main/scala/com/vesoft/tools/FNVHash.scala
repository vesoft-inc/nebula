...
object FNVHash {
  ...
  @inline
  private final def calc(prime: BigInt, mod: BigInt)(hash: BigInt, b: Byte): BigInt =
    ((hash * prime) % mod) ^ (b & MASK)

  @inline
  private final def calcA(prime: BigInt, mod: BigInt)(hash: BigInt, b: Byte): BigInt =
  ...
  /**
    ...
    */
  @inline
  def hash64(data: Array[Byte]): BigInt = data.foldLeft(INIT64)(calc(PRIME64, MOD64))
  ...
  /**
    ...
    */
  @inline
  def hash64a(data: Array[Byte]): BigInt = data.foldLeft(INIT64)(calcA(PRIME64, MOD64))
