...
class UpgraderSpace {
 ...
 private:
  ...
  std::unordered_map<TagID, std::unordered_set<std::shared_ptr<nebula::meta::cpp2::IndexItem>>>
      tagIndexes_;
  ...
  std::unordered_map<EdgeType, std::unordered_set<std::shared_ptr<nebula::meta::cpp2::IndexItem>>>
      edgeIndexes_;
