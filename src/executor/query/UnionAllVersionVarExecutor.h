...
#ifndef EXECUTOR_QUERY_UNIONALLVERSIONVAREXECUTOR_H_
#define EXECUTOR_QUERY_UNIONALLVERSIONVAREXECUTOR_H_
...
#endif   // EXECUTOR_QUERY_UNIONALLVERSIONVAREXECUTOR_H_
