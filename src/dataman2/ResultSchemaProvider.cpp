...
const FieldValue& ResultSchemaProvider::ResultSchemaField::getDefault() const {
...
bool ResultSchemaProvider::ResultSchemaField::nullable() const {
    // The result should be always nullable
    return true;
}


bool ResultSchemaProvider::ResultSchemaField::hasDefault() const {
    // The result should never have default value
    return false;
}
