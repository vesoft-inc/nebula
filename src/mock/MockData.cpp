...
std::vector<VectorElement> MockData::vectors_ = {
    {1, {0.1, 0.2, 0.3}},    {2, {0.2, 0.4, 0.6}},    {3, {0.3, 0.6, 0.9}},
    {4, {0.4, 0.8, 1.2}},    {5, {0.5, 1.0, 1.5}},    {6, {0.6, 1.2, 1.8}},
    {7, {0.7, 1.4, 2.1}},    {8, {0.8, 1.6, 2.4}},    {9, {0.9, 1.8, 2.7}},
    {10, {1.0, 2.0, 3.0}},   {11, {1.1, 2.2, 3.3}},   {12, {1.2, 2.4, 3.6}},
    {13, {1.3, 2.6, 3.9}},   {14, {1.4, 2.8, 4.2}},   {15, {1.5, 3.0, 4.5}},
    {16, {1.6, 3.2, 4.8}},   {17, {1.7, 3.4, 5.1}},   {18, {1.8, 3.6, 5.4}},
    {19, {1.9, 3.8, 5.7}},   {20, {2.0, 4.0, 6.0}},   {21, {2.1, 4.2, 6.3}},
    {22, {2.2, 4.4, 6.6}},   {23, {2.3, 4.6, 6.9}},   {24, {2.4, 4.8, 7.2}},
    {25, {2.5, 5.0, 7.5}},   {26, {2.6, 5.2, 7.8}},   {27, {2.7, 5.4, 8.1}},
    {28, {2.8, 5.6, 8.4}},   {29, {2.9, 5.8, 8.7}},   {30, {3.0, 6.0, 9.0}},
    {31, {3.1, 6.2, 9.3}},   {32, {3.2, 6.4, 9.6}},   {33, {3.3, 6.6, 9.9}},
    {34, {3.4, 6.8, 10.2}},  {35, {3.5, 7.0, 10.5}},  {36, {3.6, 7.2, 10.8}},
    {37, {3.7, 7.4, 11.1}},  {38, {3.8, 7.6, 11.4}},  {39, {3.9, 7.8, 11.7}},
    {40, {4.0, 8.0, 12.0}},  {41, {4.1, 8.2, 12.3}},  {42, {4.2, 8.4, 12.6}},
    {43, {4.3, 8.6, 12.9}},  {44, {4.4, 8.8, 13.2}},  {45, {4.5, 9.0, 13.5}},
    {46, {4.6, 9.2, 13.8}},  {47, {4.7, 9.4, 14.1}},  {48, {4.8, 9.6, 14.4}},
    {49, {4.9, 9.8, 14.7}},  {50, {5.0, 10.0, 15.0}}, {51, {5.1, 10.2, 15.3}},
    {52, {5.2, 10.4, 15.6}}, {53, {5.3, 10.6, 15.9}}, {54, {5.4, 10.8, 16.2}},
    {55, {5.5, 11.0, 16.5}}, {56, {5.6, 11.2, 16.8}}, {57, {5.7, 11.4, 17.1}},
    {58, {5.8, 11.6, 17.4}}, {59, {5.9, 11.8, 17.7}}, {60, {6.0, 12.0, 18.0}},
    {61, {6.1, 12.2, 18.3}}, {62, {6.2, 12.4, 18.6}}, {63, {6.3, 12.6, 18.9}},
    {64, {6.4, 12.8, 19.2}}, {65, {6.5, 13.0, 19.5}}, {66, {6.6, 13.2, 19.8}},
    {67, {6.7, 13.4, 20.1}}, {68, {6.8, 13.6, 20.4}}, {69, {6.9, 13.8, 20.7}},
    {70, {7.0, 14.0, 21.0}}, {71, {7.1, 14.2, 21.3}}, {72, {7.2, 14.4, 21.6}},
    {73, {7.3, 14.6, 21.9}}, {74, {7.4, 14.8, 22.2}}, {75, {7.5, 15.0, 22.5}},
    {76, {7.6, 15.2, 22.8}}, {77, {7.7, 15.4, 23.1}}, {78, {7.8, 15.6, 23.4}},
    {79, {7.9, 15.8, 23.7}}, {80, {8.0, 16.0, 24.0}}, {81, {8.1, 16.2, 24.3}},
    {82, {8.2, 16.4, 24.6}}, {83, {8.3, 16.6, 24.9}}, {84, {8.4, 16.8, 25.2}},
};

std::vector<VecEdge> MockData::vecEdges_ = {
    {1, 3, {0.2, 0.4, 0.6}},     {2, 4, {0.3, 0.6, 0.9}},     {3, 6, {0.5, 1.0, 1.5}},
    {4, 7, {0.6, 1.2, 1.8}},     {5, 8, {0.7, 1.4, 2.1}},     {6, 9, {0.8, 1.6, 2.4}},
    {7, 10, {0.9, 1.8, 2.7}},    {8, 11, {1.0, 2.0, 3.0}},    {9, 12, {1.1, 2.2, 3.3}},
    {10, 13, {1.2, 2.4, 3.6}},   {11, 14, {1.3, 2.6, 3.9}},   {12, 15, {1.4, 2.8, 4.2}},
    {13, 16, {1.5, 3.0, 4.5}},   {14, 17, {1.6, 3.2, 4.8}},   {15, 18, {1.7, 3.4, 5.1}},
    {16, 19, {1.8, 3.6, 5.4}},   {17, 20, {1.9, 3.8, 5.7}},   {18, 21, {2.0, 4.0, 6.0}},
    {19, 22, {2.1, 4.2, 6.3}},   {20, 23, {2.2, 4.4, 6.6}},   {21, 24, {2.3, 4.6, 6.9}},
    {22, 25, {2.4, 4.8, 7.2}},   {23, 26, {2.5, 5.0, 7.5}},   {24, 27, {2.6, 5.2, 7.8}},
    {25, 28, {2.7, 5.4, 8.1}},   {26, 29, {2.8, 5.6, 8.4}},   {27, 30, {2.9, 5.8, 8.7}},
    {28, 31, {3.0, 6.0, 9.0}},   {29, 32, {3.1, 6.2, 9.3}},   {30, 33, {3.2, 6.4, 9.6}},
    {31, 34, {3.3, 6.6, 9.9}},   {32, 35, {3.4, 6.8, 10.2}},  {33, 36, {3.5, 7.0, 10.5}},
    {34, 37, {3.6, 7.2, 10.8}},  {35, 38, {3.7, 7.4, 11.1}},  {36, 39, {3.8, 7.6, 11.4}},
    {37, 40, {3.9, 7.8, 11.7}},  {38, 41, {4.0, 8.0, 12.0}},  {39, 42, {4.1, 8.2, 12.3}},
    {40, 43, {4.2, 8.4, 12.6}},  {41, 44, {4.3, 8.6, 12.9}},  {42, 45, {4.4, 8.8, 13.2}},
    {43, 46, {4.5, 9.0, 13.5}},  {44, 47, {4.6, 9.2, 13.8}},  {45, 48, {4.7, 9.4, 14.1}},
    {46, 49, {4.8, 9.6, 14.4}},  {47, 50, {4.9, 9.8, 14.7}},  {48, 51, {5.0, 10.0, 15.0}},
    {49, 52, {5.1, 10.2, 15.3}}, {50, 53, {5.2, 10.4, 15.6}}, {51, 54, {5.3, 10.6, 15.9}},
    {52, 55, {5.4, 10.8, 16.2}}, {53, 56, {5.5, 11.0, 16.5}}, {54, 57, {5.6, 11.2, 16.8}},
    {55, 58, {5.7, 11.4, 17.1}}, {56, 59, {5.8, 11.6, 17.4}}, {57, 60, {5.9, 11.8, 17.7}},
    {58, 61, {6.0, 12.0, 18.0}}, {59, 62, {6.1, 12.2, 18.3}}, {60, 63, {6.2, 12.4, 18.6}},
    {61, 64, {6.3, 12.6, 18.9}}, {62, 65, {6.4, 12.8, 19.2}}, {63, 66, {6.5, 13.0, 19.5}},
    {64, 67, {6.6, 13.2, 19.8}}, {65, 68, {6.7, 13.4, 20.1}}, {66, 69, {6.8, 13.6, 20.4}},
    {67, 70, {6.9, 13.8, 20.7}}, {68, 71, {7.0, 14.0, 21.0}}, {69, 72, {7.1, 14.2, 21.3}},
    {70, 73, {7.2, 14.4, 21.6}}, {71, 74, {7.3, 14.6, 21.9}}, {72, 75, {7.4, 14.8, 22.2}},
    {73, 76, {7.5, 15.0, 22.5}}, {74, 77, {7.6, 15.2, 22.8}}, {75, 78, {7.7, 15.4, 23.1}},
    {76, 79, {7.8, 15.6, 23.4}}, {77, 80, {7.9, 15.8, 23.7}}, {78, 81, {8.0, 16.0, 24.0}},
    {79, 82, {8.1, 16.2, 24.3}}, {80, 83, {8.2, 16.4, 24.6}}, {81, 84, {8.3, 16.6, 24.9}},
    {82, 85, {8.4, 16.8, 25.2}}, {83, 86, {8.5, 17.0, 25.5}}, {84, 87, {8.6, 17.2, 25.8}},
};
...
nebula::meta::cpp2::ColumnDef MockData::mockVectorTagAnnIndexColumn() {
  meta::cpp2::ColumnDef col;
  col.name = "vec";
  col.type.type_ref() = PropertyType::VECTOR;
  return col;
}
...
nebula::meta::cpp2::ColumnDef MockData::mockVectorEdgeAnnIndexColumn() {
  meta::cpp2::ColumnDef col;
  col.name = "vec";
  col.type.type_ref() = PropertyType::VECTOR;
  return col;
