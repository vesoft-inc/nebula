...
std::shared_ptr<const nebula::meta::NebulaSchemaProvider> AdHocSchemaManager::getTagSchema(
...
std::shared_ptr<const nebula::meta::NebulaSchemaProvider> AdHocSchemaManager::getTagSchemaFromMap(
    GraphSpaceID space, TagID tag, SchemaVer ver) {
  folly::RWSpinLock::ReadHolder rh(tagLock_);
...
std::shared_ptr<const nebula::meta::NebulaSchemaProvider> AdHocSchemaManager::getEdgeSchema(
...
std::shared_ptr<const nebula::meta::NebulaSchemaProvider> AdHocSchemaManager::getEdgeSchemaFromMap(
    GraphSpaceID space, EdgeType edge, SchemaVer ver) {
  folly::RWSpinLock::ReadHolder rh(edgeLock_);
