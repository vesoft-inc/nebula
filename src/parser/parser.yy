...
%token KW_PARTITION_NUM KW_REPLICA_FACTOR KW_DROP KW_REMOVE KW_SPACES KW_INGEST KW_UUID KW_TIME_SERIES
...
space_opt_list
 ...
 space_opt_item
    ...
    | KW_TIME_SERIES ASSIGN KW_Y {
        $$ = new SpaceOptItem(SpaceOptItem::TIME_SERIES, true);
    }
    | KW_TIME_SERIES ASSIGN KW_N {
        $$ = new SpaceOptItem(SpaceOptItem::TIME_SERIES, false);
    }
