...
#define CHECK_LEXICAL_ERROR(STR)                                            \
    ...
    std::vector<Validator> validators = {
        ...
        CHECK_SEMANTIC_TYPE("Contains", TokenType::KW_CONTAINS),
        CHECK_SEMANTIC_TYPE("contains", TokenType::KW_CONTAINS),
        CHECK_SEMANTIC_TYPE("INSTALL", TokenType::KW_INSTALL),
        CHECK_SEMANTIC_TYPE("Install", TokenType::KW_INSTALL),
        CHECK_SEMANTIC_TYPE("install", TokenType::KW_INSTALL),
        CHECK_SEMANTIC_TYPE("UNINSTALL", TokenType::KW_UNINSTALL),
        CHECK_SEMANTIC_TYPE("Uninstall", TokenType::KW_UNINSTALL),
        CHECK_SEMANTIC_TYPE("uninstall", TokenType::KW_UNINSTALL),
        CHECK_SEMANTIC_TYPE("PLUGIN", TokenType::KW_PLUGIN),
        CHECK_SEMANTIC_TYPE("Plugin", TokenType::KW_PLUGIN),
        CHECK_SEMANTIC_TYPE("plugin", TokenType::KW_PLUGIN),
        CHECK_SEMANTIC_TYPE("SONAME", TokenType::KW_SONAME),
        CHECK_SEMANTIC_TYPE("Soname", TokenType::KW_SONAME),
        CHECK_SEMANTIC_TYPE("soname", TokenType::KW_SONAME),
        CHECK_SEMANTIC_TYPE("PLUGINS", TokenType::KW_PLUGINS),
        CHECK_SEMANTIC_TYPE("Plugins", TokenType::KW_PLUGINS),
        CHECK_SEMANTIC_TYPE("plugins", TokenType::KW_PLUGINS),
