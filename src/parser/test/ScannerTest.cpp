...
#define CHECK_LEXICAL_ERROR(STR)                                            \
    ...
    std::vector<Validator> validators = {
        ...
        CHECK_SEMANTIC_VALUE("0o123", TokenType::INTEGER, 0123),
        ...
        CHECK_SEMANTIC_VALUE("0o0777777777777777777777", TokenType::INTEGER,
                              00777777777777777777777),
        CHECK_LEXICAL_ERROR("9223372036854775809"),
        CHECK_LEXICAL_ERROR("0x8000000000000001"),
        CHECK_LEXICAL_ERROR("0o01000000000000000000001"),
