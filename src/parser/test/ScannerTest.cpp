...
#define CHECK_LEXICAL_ERROR(STR)                                     \
  ...
  std::vector<Validator> validators = {
      ...
      CHECK_SEMANTIC_TYPE("remove", TokenType::KW_REMOVE),
      CHECK_SEMANTIC_TYPE("Remove", TokenType::KW_REMOVE),
      CHECK_SEMANTIC_TYPE("ATTACH", TokenType::KW_ATTACH),
      CHECK_SEMANTIC_TYPE("attach", TokenType::KW_ATTACH),
      CHECK_SEMANTIC_TYPE("Attach", TokenType::KW_ATTACH),
      CHECK_SEMANTIC_TYPE("DETACH", TokenType::KW_DETACH),
      CHECK_SEMANTIC_TYPE("detach", TokenType::KW_DETACH),
      CHECK_SEMANTIC_TYPE("Detach", TokenType::KW_DETACH),
      ...
      CHECK_SEMANTIC_TYPE("Leader", TokenType::KW_LEADER),
      CHECK_SEMANTIC_TYPE("leader", TokenType::KW_LEADER),
      CHECK_SEMANTIC_TYPE("DISK", TokenType::KW_DISK),
      CHECK_SEMANTIC_TYPE("Disk", TokenType::KW_DISK),
      CHECK_SEMANTIC_TYPE("disk", TokenType::KW_DISK),
      CHECK_SEMANTIC_TYPE("ACROSS", TokenType::KW_ACROSS),
      CHECK_SEMANTIC_TYPE("Across", TokenType::KW_ACROSS),
      CHECK_SEMANTIC_TYPE("across", TokenType::KW_ACROSS),
