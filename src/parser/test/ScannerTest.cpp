...
#define CHECK_SEMANTIC_VALUE(STR, TYPE, value)                              \
    ...
    std::vector<Validator> validators = {
        ...
        CHECK_SEMANTIC_TYPE("comment", TokenType::KW_COMMENT),
        CHECK_SEMANTIC_TYPE("Comment", TokenType::KW_COMMENT),
        CHECK_SEMANTIC_TYPE("ENGINE", TokenType::KW_ENGINE),
        CHECK_SEMANTIC_TYPE("engine", TokenType::KW_ENGINE),
        CHECK_SEMANTIC_TYPE("Engine", TokenType::KW_ENGINE),
        CHECK_SEMANTIC_TYPE("ENCRYPT", TokenType::KW_ENCRYPT),
        CHECK_SEMANTIC_TYPE("encrypt", TokenType::KW_ENCRYPT),
        CHECK_SEMANTIC_TYPE("Encrypt", TokenType::KW_ENCRYPT),
        CHECK_SEMANTIC_TYPE("COMPRESS", TokenType::KW_COMPRESS),
        CHECK_SEMANTIC_TYPE("compress", TokenType::KW_COMPRESS),
        CHECK_SEMANTIC_TYPE("Compress", TokenType::KW_COMPRESS),
        CHECK_SEMANTIC_TYPE("CHARACTER", TokenType::KW_CHARACTER),
        CHECK_SEMANTIC_TYPE("character", TokenType::KW_CHARACTER),
        CHECK_SEMANTIC_TYPE("Character", TokenType::KW_CHARACTER),
