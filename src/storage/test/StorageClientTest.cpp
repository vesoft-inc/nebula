...
TEST(StorageClientTest, VerticesInterfacesTest) {
...

    {
        ...
        ASSERT_EQ(1, results.size());
        EXPECT_EQ(0, results[0].result.failed_codes.size());
        EXPECT_EQ(20, results[0].schema.columns.size());
