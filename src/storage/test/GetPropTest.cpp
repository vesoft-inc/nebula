...
void verifyResult(const std::vector<nebula::Row>& expect, const nebula::DataSet& dataSet) {
...
TEST(GetPropTest, AllPropertyInOneSchemaTest) {
  ...
  }
  {
    ...
    ASSERT_EQ(0, (*resp.result_ref()).failed_parts.size());
    nebula::DataSet expected;
    expected.colNames = {"101.playerName",
                         "101.teamName",
                         "101.startYear",
                         "101.endYear",
                         "101.teamCareer",
