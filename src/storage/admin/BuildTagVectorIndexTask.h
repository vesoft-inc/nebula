...
#ifndef STORAGE_ADMIN_BUILDTAGVECTORINDEXTASK_H_
#define STORAGE_ADMIN_BUILDTAGVECTORINDEXTASK_H_
 ...
 *
 */
class BuildTagVectorIndexTask : public BuildVectorIndexTask {
 public:
  BuildTagVectorIndexTask(StorageEnv* env, TaskContext&& ctx)
...
#endif  // STORAGE_ADMIN_BUILDTAGVECTORINDEXTASK_H_
