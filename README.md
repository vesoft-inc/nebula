...
Nebula Graph 1.x is not actively maintained. Please move to Nebula Graph 2.x. The data format, rpc protocals, clients, etc. are not compatible.

This repo hosts the code of versions prior to v1.2.1 and v2.5.0 later. If you are looking to use the versions between v2.0.0 and v2.5.0, please head to[Nebula Graph repo](https://github.com/vesoft-inc/nebula-graph). 
